...
import HeroImage from '../assets/luciano_lugani_.jpg'
  ...
  return (
    <div className='bg-black text-white text-center py-16'>
        ...
        <h1 className='text-4xl font-bold'>
            I'm {" "}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Luciano Lugani</span>
